...
<DataTable
  headers={["Plan", "Product ID Env Var", "Credits", "Price"]}
  rows={[
    ["Starter", "CREEM_STARTER_PRODUCT_ID", "100 / month", "$10 / month"],
    ["Creator", "CREEM_PRO_PRODUCT_ID", "500 / month", "$29 / month"],
    ["Professional", "CREEM_ENTERPRISE_PRODUCT_ID", "2,000 / month", "$79 / month"],
    ["Nova Pro Max", "CREEM_PRO_MAX_PRODUCT_ID", "Unlimited (sentinel)", "$3,000 one-time"],
  ]}
/>
...
<DataTable
  headers={["Queue", "Concurrency", "Purpose"]}
  rows={[
...
<DataTable
  headers={["Route", "Limit", "Key"]}
  rows={[
    ["/api/chat", "20 req / min", "User ID"],
...
<DataTable
  headers={["Provider", "Endpoint", "Default Model"]}
  rows={[
...
<DataTable
  ...
  rows={[
    ["Unit / Component", "Vitest + Testing Library", "Validators, helpers, React components"],
