...
import { CommandCard } from "@/components/shared/command-card";
import { Button } from "@/components/ui/button";
import { Card, CardContent } from "@/components/ui/card";
import { BAR_FILL, FADE_IN_UP, LOGO_FLOAT, STAGGER_CONTAINER } from "@/lib/animations";
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-6 text-center relative z-10">
            <motion.div variants={FADE_IN_UP} initial="initial" animate="animate">
              ...
              <h1 className="text-6xl md:text-9xl font-black tracking-[calc(-0.04em)] leading-[0.85] mb-8 uppercase">
                <span className="bg-gradient-to-b from-foreground via-foreground to-primary bg-clip-text text-transparent">
                  Ship Your
                </span>{" "}
                <br />
              ...
              <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto mb-12 font-medium leading-tight">
                A premium command-center SAAS with auth, database, and global payments. Built for
                builders who value{" "}
                <span className="text-orange-900 dark:text-primary font-extrabold uppercase tracking-tight">
                  speed and design.
                </span>
              </p>
            ...
            <CommandCard
              glow
              className="mt-20 max-w-5xl mx-auto border-4 md:border-8 border-slate-900 !rounded-[1.5rem] md:!rounded-[2.5rem]"
            >
              <div className="bg-slate-900/50 backdrop-blur-3xl flex flex-col items-stretch h-full">
                <div className="h-8 md:h-10 flex items-center px-4 md:px-6 gap-2 border-b border-white/5 bg-white/5">
                  ...
                  <div className="ml-2 md:ml-4 text-[8px] md:text-[10px] font-black uppercase tracking-widest text-white/30 truncate">
                    system_v1.0.0 — active
                  </div>
                </div>
                ...
                <div className="p-4 md:p-10 grid gap-4 md:gap-6 md:grid-cols-2 text-left">
                  <div className="space-y-4 md:space-y-6">
                      ...
                      <div className="flex justify-between items-start mb-4">
                        <div className="space-y-1">
                          ...
                          <div className="text-2xl md:text-3xl font-black text-white">
                            {formatCurrency(4291000)}
                          </div>
                        </div>
                        <div className="px-2 py-0.5 rounded bg-emerald-500/10 text-emerald-400 text-[8px] md:text-[10px] font-black uppercase tracking-widest">
                          +12.5%
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-3 md:gap-4">
                      <div className="p-4 md:p-6 rounded-2xl md:rounded-3xl bg-white/5 border border-white/10">
                        <div className="text-[8px] md:text-[10px] font-black uppercase tracking-widest text-white/40 mb-1 md:mb-2">
                          Active Users
                        </div>
                  ...
                  <div className="p-6 md:p-8 rounded-2xl md:rounded-3xl bg-slate-900 border border-white/10 flex flex-col">
                    ...
                    <div className="space-y-2 md:space-y-4 flex-1">
                      {[
                        ...
                        <div
                          key={evt.label}
                          className="flex justify-between items-center text-[10px] md:text-xs py-1.5 md:py-2 border-b border-white/5 last:border-0 opacity-80 hover:opacity-100 transition-opacity"
                        >
        ...
        <section className="py-32 bg-secondary/50">
          <div className="max-w-7xl mx-auto px-4 md:px-6">
            <div className="flex flex-col items-center text-center mb-20 gap-8 max-w-3xl mx-auto">
              <div>
                <span className="text-xs font-black text-primary uppercase tracking-widest mb-4 block">
                  Features
                </span>
        ...
        <section className="py-24 bg-background border-y border-border">
          <div className="max-w-4xl mx-auto px-4 md:px-6 text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-12 font-medium max-w-2xl mx-auto">
              This boilerplate comes with pre-built pricing components and Creem integration.
              Customize your plans and go live in minutes.
            </p>
            <Button
              asChild
              size="lg"
              className="h-16 px-12 text-lg bg-foreground text-background hover:bg-muted rounded-full w-full md:w-auto transition-colors"
            >
        ...
        <section className="py-32">
          <div className="max-w-7xl mx-auto px-4 md:px-6">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              {secondaryFeatures.map((f, _i) => (
                <CommandCard
                  key={f.title}
                  className="bg-secondary/50 !rounded-3xl hover:bg-slate-900 border-white/5 text-foreground hover:text-white transition-colors"
                >
                  <div className="p-8">
          ...
          <Card className="max-w-7xl mx-auto overflow-hidden border border-border bg-[#020617] relative rounded-[3rem]">
            ...
            <CardContent className="p-8 md:p-32 text-center relative z-10 box-border">
              ...
              <Button
                asChild
                size="lg"
                className="h-16 px-12 text-lg bg-white text-black hover:bg-primary transition-colors w-full md:w-auto"
              >
...
const primaryFeatures = [
  {
    ...
    title: "Secure Auth",
    description:
      "Enterprise-grade authentication powered by Supabase. Email, OAuth, and magic links out of the box.",
  },
  {
    icon: <CreditCard className="size-8" strokeWidth={2.5} />,
    title: "Global Payments",
    description:
      "Creem handles all the messy stuff. Tax compliance, subscriptions, and global checkout in minutes.",
  },
  {
    icon: <Database className="size-8" strokeWidth={2.5} />,
    title: "Powerful DB",
    description:
      "A secure, scaleable Postgres database with Row-Level Security to keep your customer data safe.",
  },
];
