...
export default async function SettingsPage() {
  ...
  return (
    <div className="space-y-10">
      <div>
        <span className="text-[10px] font-black uppercase tracking-[0.2em] text-primary mb-2 block">Configuration</span>
        <h1 className="text-4xl md:text-5xl font-black tracking-tighter uppercase leading-none text-foreground">System Settings</h1>
        <p className="text-muted-foreground font-medium mt-4">Review your account parameters and authentication protocols.</p>
      </div>
      ...
      <div className="max-w-3xl space-y-8">
         <Card className="border border-border shadow-sm bg-card">
            <CardHeader className="p-8">
               ...
               <CardDescription>Authenticated user details synchronized with the CREEMxSAAS network.</CardDescription>
            </CardHeader>
            <CardContent className="p-8 pt-0 space-y-6">
               <div className="grid gap-6 md:grid-cols-2">
                  <div className="space-y-2">
                     <Label className="text-[10px] uppercase font-black tracking-widest text-muted-foreground">Identity Name</Label>
                     <div className="h-12 flex items-center px-4 bg-secondary rounded-xl border border-border font-bold text-foreground">
                        {name}
                     </div>
                  </div>
                  <div className="space-y-2">
                     <Label className="text-[10px] uppercase font-black tracking-widest text-muted-foreground">Email Vector</Label>
               ...
               <div className="p-6 bg-primary/5 rounded-2xl border border-primary/10 flex items-center justify-between">
                  <div className="flex items-center gap-4">
                     ...
                     <div>
                        <p className="text-[10px] font-black uppercase tracking-widest text-primary">Access Protocol</p>
         ...
         <Card className="border border-destructive/20 bg-destructive/5 overflow-hidden shadow-sm">
            ...
            <CardContent className="p-8 pt-0">
               <div className="flex flex-col md:flex-row items-center justify-between gap-6 p-6 bg-card rounded-3xl border border-destructive/10">
                  <div>
                     <p className="font-black text-sm uppercase tracking-tight text-foreground">Terminate Account</p>
                     <p className="text-xs text-muted-foreground font-medium">This will permanently purge all system data.</p>
                  </div>
                  <Button variant="destructive" className="rounded-xl font-black uppercase tracking-widest text-[10px] px-6 h-10 transition-transform active:scale-95">
                     Purge System
                  </Button>
               </div>
            </CardContent>
