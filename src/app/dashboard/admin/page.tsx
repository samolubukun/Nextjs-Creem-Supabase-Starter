  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-2">
        <h1 className="text-2xl font-black uppercase tracking-tighter text-foreground">Admin Dashboard</h1>
        <p className="text-sm font-bold uppercase tracking-widest text-muted-foreground">Platform Analytics & User Management</p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="p-6 bg-card border border-border rounded-3xl shadow-sm space-y-2">
          ...
          <p className="text-sm font-black uppercase tracking-widest text-muted-foreground">Total Users</p>
        ...
        <div className="p-6 bg-card border border-border rounded-3xl shadow-sm space-y-2">
          ...
          <p className="text-sm font-black uppercase tracking-widest text-muted-foreground">Active Subs</p>
        ...
        <div className="p-6 bg-card border border-border rounded-3xl shadow-sm space-y-2">
          ...
          <p className="text-sm font-black uppercase tracking-widest text-muted-foreground">B2B Seats</p>
        ...
        <div className="p-6 bg-card border border-border rounded-3xl shadow-sm space-y-2">
          ...
          <p className="text-sm font-black uppercase tracking-widest text-muted-foreground">Active Licenses</p>
        ...
        <div className="p-6 bg-card border border-border rounded-3xl shadow-sm space-y-2">
          ...
          <p className="text-sm font-black uppercase tracking-widest text-muted-foreground">LTD Purchases</p>
        ...
        <div className="p-6 bg-card border border-border rounded-3xl shadow-sm space-y-2">
          ...
          <p className="text-sm font-black uppercase tracking-widest text-muted-foreground">AI Conversations</p>
      ...
      <div className="bg-card border text-sm border-border rounded-3xl shadow-sm overflow-hidden text-foreground">
        <table className="w-full text-left">
          <thead className="bg-secondary/50 border-b border-border">
            <tr>
              <th className="p-4 font-black uppercase tracking-widest text-[10px] text-muted-foreground">User</th>
              <th className="p-4 font-black uppercase tracking-widest text-[10px] text-muted-foreground">Joined</th>
          ...
          <tbody className="divide-y divide-border">
            {profilesWithSubs?.map((profile: any) => {
              ...
              return (
                <tr key={profile.id} className="hover:bg-secondary/30 transition-colors group">
                  <td className="p-4">
                    <p className="font-bold text-foreground group-hover:text-primary transition-colors">{profile.user_metadata?.full_name || 'Guest'}</p>
